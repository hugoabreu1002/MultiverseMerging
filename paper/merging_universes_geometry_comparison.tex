...
We implement both geometries and their DE-only and DE+DM variants within a unified numerical framework. The code solves the Friedmann equation~\eqref{eq:friedmann} on a redshift grid from $z=0$ to $z=10$ with $n=5000$ steps. The scale factor at first contact is set to $a_{\rm contact}=0.3$, corresponding to $z_{\rm contact}\approx 2.3$.

\subsection{Data}

We use the simulated Pantheon+ SN Ia dataset consisting of 280 distance modulus measurements distributed over $0.02 < z < 2.3$. The data are generated using the Planck 2018 $\Lambda$CDM best-fit parameters as the underlying true cosmology, with Gaussian scatter added according to the observed error budget. This allows us to compare how well each merger model variant fits the same data.
...
\begin{table}[H]
\centering
\caption{Comparison of model fits to simulated Pantheon+ SN Ia data.}
\label{tab:comparison}
\begin{tabular}{lcccc}
\toprule
Model & $\chi^2$ & $\Delta\chi^2$ & BIC & $H_0$ [km/s/Mpc] \\
\midrule
5D Spatial (DE only) & $2.832\times10^8$ & $-1.116\times10^6$ & $2.832\times10^8$ & 67.4 \\
5D Spatial + DM     & $2.836\times10^8$ & $-7.505\times10^5$ & $2.836\times10^8$ & 69.6 \\
4D Temporal (DE only) & $2.851\times10^8$ & $+7.419\times10^5$ & $2.851\times10^8$ & 67.4 \\
4D Temporal + DM     & $2.851\times10^8$ & $+7.920\times10^5$ & $2.851\times10^8$ & 69.6 \\
$\Lambda$CDM          & $2.844\times10^8$ & --- & --- & 67.4 \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{The 5D spatial brane model with DE only provides the best fit.} It achieves $\Delta\chi^2 \approx -1.1\times10^6$ relative to $\Lambda$CDM, and yields the lowest BIC among all variants. The 4D temporal models \textit{underperform} compared to $\Lambda$CDM, with positive $\Delta\chi^2$.
...
\textbf{The 5D geometry is favored over 4D.} The spatial brane picture produces dark energy and matter distributions that match the SN Ia distance modulus data more naturally than the temporal quantum interference picture, given the current calibration. This result aligns with the broader theoretical literature favoring 5D geometric approaches to the dark sector~\cite{panigrahi2007, ramirez2025, masarrat2025, silva2024}.
...
M.~Kamionkowski and A.~G.~Riess, Annu. Rev. Nucl. Part. Sci. \textbf{73}, 153 (2023).

\bibitem{hu2023}
J.-P.~Hu and F.-Y.~Wang, Universe \textbf{9}, 94 (2023).

\bibitem{poulin2019}
V.~Poulin, T.~L.~Smith, T.~Karwal, and M.~Kamionkowski, Phys. Rev. Lett. \textbf{122}, 221301 (2019).

\bibitem{pedrotti2024}
D.~Pedrotti, J.-Q.~Jiang, L.~A.~Escamilla, S.~Santos da Costa, and S.~Vagnozzi, arXiv:2408.04530 (2024).

\bibitem{pang2025}
Y.-H.~Pang, X.~Zhang, and Q.-G.~Huang, arXiv:2503.21600 (2025).

\bibitem{panigrahi2007}
D.~Panigrahi and S.~Chatterjee, arXiv:0709.0374 (2007).

\bibitem{ramirez2025}
J.~G.~Ram\'irez, Preprints 202507.0648 (2025).

\bibitem{masarrat2025}
B.~Masarrat, ``A 5D Scalar Field Integrated with General Relativity: A Dark Matter-Free Explanation for Gravitational Lensing and Cosmological Observations'' (2025).

\bibitem{silva2024}
Y.~N.~Silva, ``Foundations for the Extrinsic Universe: Expanding Big Bang Universe Model'' (2024).

\bibitem{netchitailo2015}
V.~S.~Netchitailo, J. High Energy Phys. Gravit. Cosmol. \textbf{1}, 25 (2015).

\bibitem{hamada2022}
Y.~Hamada, H.~Kawai, and K.~Kawana, J. High Energy Phys. \textbf{12}, 100 (2022).

\bibitem{tan}
D.~Tan, ``A novel space-time transformation revealing the existence of mirror universe,'' preprint.

\bibitem{singh2025}
T.~P.~Singh, Preprints 202505.1074 (2025).
